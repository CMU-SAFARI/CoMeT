...
parser.add_argument('-wd', '--working_directory', type=str, required=True, help='The directory where the ramulator executable is located')
parser.add_argument('-od', '--output_directory', type=str, required=True, help='The directory where the output files will be stored')
parser.add_argument('-td', '--trace_directory', type=str, required=True, help='The directory where the traces are located')
